...
<head>
    ...
    <title>Doctor Portal - MedFlow</title>
    ...
    <style>
        ...
        .main-content { flex-grow: 1; padding: 2rem; width: 100%; transition: all 0.3s ease; }
...
<body>
    ...
    <div class="mobile-header">
        ...
        <span class="fw-bold text-primary">Doctor Portal</span>
    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <p class="text-muted small d-none d-lg-block">Doctor Portal</p>
           <nav id="doctorNav">
    ...
    <script>
        ...
        document.querySelectorAll('#doctorNav .sidebar-link').forEach(link => {
